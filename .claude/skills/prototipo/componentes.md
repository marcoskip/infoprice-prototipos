...
- Linhas: hover background `--color-gray-50`
- Checkbox: styled nativo
- Input (preco sugerido): width 100%, border 1px `--color-gray-300`, focus border `--color-blue-400` + shadow-focus
